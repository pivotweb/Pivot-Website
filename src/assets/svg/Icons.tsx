...
export const VolunteerIcon: React.FC<IconProps> = ({
  className,
  width = 24,
  height = 24,
  fill = 'currentColor',
  ...
  >
    <path
      fill={fill}
      d="M7 20.025V11h1.6q.175 0 .35.038t.35.087l6.925 2.575q.35.125.563.45t.212.675q0 .525-.363.85T15.8 16h-2.625q-.125 0-.187-.012t-.163-.063l-1.6-.625l-.325.975l1.925.675q.05.025.15.038t.175.012H20q.8 0 1.4.575T22 19l-7.975 3zM1 22V11h4v11zm15-9l-4.15-4.05q-.775-.75-1.312-1.662T10 5.3q0-1.375.963-2.337T13.3 2q.8 0 1.5.338t1.2.912q.5-.575 1.2-.913T18.7 2q1.375 0 2.338.963T22 5.3q0 1.075-.525 1.988t-1.3 1.662z"
    />
  </svg>
)

export const ShakeHandsIcon: React.FC<IconProps> = ({
  className,
  width = 640,
  height = 512,
  fill = 'currentColor',
